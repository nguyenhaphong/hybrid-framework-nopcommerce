...
public class Level_02_Base_Page_Part_III extends BasePage {
	WebDriver driver;
	String emailAddress;
	...
	public void TC_04_Register_Existing_Email() {
		...
		Assert.assertEquals(getElementText(driver, "//div[contains(@class='message-eror')]//li"), "The specified email already exists");
